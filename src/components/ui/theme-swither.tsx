...
export function ThemeSwither() {
  ...
  return (
    <fieldset className="flex h-8 rounded-full border border-gray-alpha-300 bg-background-100">
      ...
      <div className="-ml-px -mt-px">
        ...
        <label
          ...
          className={clsx(
            "group flex h-8 w-8 cursor-pointer items-center justify-center rounded-full transition",
            resolvedTheme === "system" && "border border-gray-alpha-300 bg-gray-alpha-100",
          )}
        >
          ...
          <svg height="16" strokeLinejoin="round" viewBox="0 0 16 16" width="16">
            <path
              ...
              className={clsx(
                "duration-150 group-hover:fill-gray-1000",
                resolvedTheme === "system" ? "fill-gray-1000" : "fill-gray-700",
              )}
            />
          </svg>
        </label>
      ...
      <div className="-mt-px">
        ...
        <label
          ...
          className={clsx(
            "group flex h-8 w-8 cursor-pointer items-center justify-center rounded-full transition",
            resolvedTheme === "light" && "border border-gray-alpha-300 bg-gray-alpha-100",
          )}
        >
          ...
          <svg height="16" strokeLinejoin="round" viewBox="0 0 16 16" width="16">
            <path
              ...
              className={clsx(
                "duration-150 group-hover:fill-gray-1000",
                resolvedTheme === "light" ? "fill-gray-1000" : "fill-gray-700",
              )}
            />
          </svg>
        </label>
      ...
      <div className="-mr-px -mt-px">
        ...
        <label
          ...
          className={clsx(
            "group flex h-8 w-8 cursor-pointer items-center justify-center rounded-full transition",
            resolvedTheme === "dark" && "border border-gray-alpha-300 bg-gray-alpha-100",
          )}
        >
          ...
          <svg height="16" strokeLinejoin="round" viewBox="0 0 16 16" width="16">
            <path
              ...
              className={clsx(
                "duration-150 group-hover:fill-gray-1000",
                resolvedTheme === "dark" ? "fill-gray-1000" : "fill-gray-700",
              )}
            />
          </svg>
        </label>
