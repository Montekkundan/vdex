      ...
      >
        ...
        <div className="flex flex-col gap-y-1 px-5 pb-4 items-start w-full">
          ...
          <p className="text-sm text-muted-foreground">
            Use Files, Terminal, Settings, App Store, and code-server in one desktop.
          </p>
        </div>
      </motion.div>
    </motion.div>
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col gap-y-1 px-5 pb-4 items-start w-full">
          ...
          <p className="text-sm text-muted-foreground">
            Start, stop, snapshot, and reconnect your per-user sandbox workspace.
          </p>
        </div>
      </motion.div>
    </motion.div>
  ...
  return (
    ...
    >
      <div className="relative flex flex-col gap-y-5 items-center justify-between h-full w-full">
        ...
        <div className="flex flex-col gap-y-1 px-5 pb-4 items-start w-full">
          <h2 className="font-semibold tracking-tight text-lg">
            Stream Linux GUI Apps
          </h2>
          <p className="text-sm text-muted-foreground">
            Launch GUI apps in-browser through Xpra on your sandbox display.
          </p>
        </div>
      </div>
    </motion.div>
